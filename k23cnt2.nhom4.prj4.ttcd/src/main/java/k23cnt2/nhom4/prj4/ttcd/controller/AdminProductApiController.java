...
public class AdminProductApiController {
    ...
    // Đón nhận FormData để xử lý Thêm sản phẩm + tự động tạo các dòng Size tương ứng
    @PostMapping
    ...
    // Đón nhận FormData cập nhật sản phẩm cũ
    @PutMapping("/{id}")
    ...
    // API Đảo trạng thái kích hoạt (Toggle Status) dùng phương thức POST bảo mật
